i=$1
python train.py --gpu 0 --batch_size 4 --max_epoch 100  --log_dir log${i} --learning_rate 0.001 --decay_step 300000  --restore_model log${i} --input_list data/train_hdf5_file_list_woArea${i}.txt
